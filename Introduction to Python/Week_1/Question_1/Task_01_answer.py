...
float_value = input("Enter a float value: ")
print(f"You entered float: {float_value}")

double_value = input("Enter a double value: ")
print(f"You entered double: {double_value}")

long_double_value = input("Enter a long double value: ")
print(f"You entered long double: {long_double_value}")
